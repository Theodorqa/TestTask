	...
	public class UIButtonDataBind : Binder
	{
		...
		public void OnClick()
		{
			...
			if (!cancel)
			{
				...
				Settings.Fsm?.Invoke("ButtonToFSM", buttonName);
				Log.Debug("Событие отправлено в FSM");
				Settings.Model.EventManager.Invoke("ButtonToFSM", buttonName);
		...
		protected void update()
		{
			...
			if (button.interactable != defaultEnable)
				button.interactable = defaultEnable;
		}
	}
}